...
/**
 * @fileOverview Converts text to speech using an AI model with selectable voices.
 *
...
import wav from 'wav';
import { supportedVoices } from '@/ai/voices';

const TextToSpeechInputSchema = z.object({
  text: z.string().describe('The text to be converted to speech.'),
  voice: z.enum(supportedVoices).default('Algenib').describe('The voice to use for the speech synthesis.'),
});
...
async function toWav(
  pcmData: Buffer,
  channels = 1,
  rate = 24000, // Standard sample rate for Gemini TTS
